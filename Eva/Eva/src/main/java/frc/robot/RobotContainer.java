...
private final Joystick driverController = new Joystick(1);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("RunIntakeWithJoystick", new RunIntakeWithJoystick( m_intake ));
    SmartDashboard.putData("MoveArmWithJoystick", new MoveArmWithJoystick( m_arm ));
    ...
    m_intake.setDefaultCommand(new RunIntakeWithJoystick(m_intake));
    m_arm.setDefaultCommand(new MoveArmWithJoystick(m_arm));
    ...
    m_chooser.addOption("ShootingAndBackingUp", new ShootingAndBackingUp(m_driveTrain, m_intake));
...
//goDownButton.whenPressed(new MoveArmWithSpeed(m_arm, -0.5).withTimeout(1));
//goUpButton.whenPressed(new MoveArmWithSpeed(m_arm, 0.5).withTimeout(1));
